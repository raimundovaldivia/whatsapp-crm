...
router.put('/:id', async (req, res) => {
  try {
    ...
    if ((bulkPrice  ?? bulk_price)  !== undefined) updates.bulk_price  = (bulkPrice ?? bulk_price)  || null;
    if ((bulkMinQty ?? bulk_min_qty) !== undefined) updates.bulk_min_qty = (bulkMinQty ?? bulk_min_qty) || null;
